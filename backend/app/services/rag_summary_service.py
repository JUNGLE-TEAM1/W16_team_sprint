...
class OpenAIRagSummaryProvider:
    ...
    def _build_prompt(self, payload: RelatedPostsRequest, related_posts: list[RelatedPostRow]) -> str:
        ...
        return "\n\n".join(
            [
                "너는 개발 지식 공유 게시판의 RAG 추천 요약 도우미다.",
                "사용자가 작성 중인 글과 유사 게시글 목록을 보고, 각 유사 게시글마다 한국어 summary를 작성한다.",
                "각 summary는 2-3문장으로 작성하고, 왜 관련 있는지와 기존 글의 핵심 내용을 함께 담는다.",
                "과장하지 말고 제공된 유사 게시글 내용에 근거해서만 작성한다.",

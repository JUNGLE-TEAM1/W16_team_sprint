...
from backend.app.schemas.post import PostCreate, PostPage, PostRead, PostSearchType, PostUpdate
...
def list_posts(
    ...
    return service.list(q=q, search_type=search_type, tag=tag, page=page, size=size)
